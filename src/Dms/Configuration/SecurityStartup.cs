...
using AuthenticationService = Dms.Domain.Services.AuthenticationService;
using IAuthenticationService = Dms.Domain.Services.Interfaces.IAuthenticationService;
