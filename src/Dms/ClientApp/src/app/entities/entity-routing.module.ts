    ...
    RouterModule.forChild([
      {
        path: "region",
        data: {
          pageTitle: "dmsApp.region.home.title",
      ...
      },
      {
        path: "country",
        data: {
          pageTitle: "dmsApp.country.home.title",
          authorities: [Authority.ADMIN],
        },
        loadChildren: () =>
      ...
      },
      {
        path: "location",
        data: {
          pageTitle: "dmsApp.location.home.title",
          authorities: [Authority.ADMIN],
        },
        loadChildren: () =>
      ...
      },
      {
        path: "department",
        data: {
          pageTitle: "dmsApp.department.home.title",
          authorities: [Authority.ADMIN],
        },
        loadChildren: () =>
      ...
      },
      {
        path: "employee",
        data: {
          pageTitle: "dmsApp.employee.home.title",
          authorities: [Authority.ADMIN],
        },
        loadChildren: () =>
      ...
      },
      {
        path: "file-part",
        data: {
          pageTitle: "dmsApp.filePart.home.title",
          authorities: [Authority.ADMIN],
        },
        loadChildren: () =>
