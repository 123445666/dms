...
import { FilePartValidateComponent } from "./esign-validate.component";

describe("FilePart Management Update Component", () => {
    let comp: FilePartValidateComponent;
    let fixture: ComponentFixture<FilePartValidateComponent>;
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            declarations: [FilePartValidateComponent],
            providers: [
                FormBuilder,
                {
            ...
            .overrideTemplate(FilePartValidateComponent, "")
            .compileComponents();

        fixture = TestBed.createComponent(FilePartValidateComponent);
